...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    let mounted = true;
    Promise.all([api("/complaints", { token }), api("/users", { token })])
  ...
  const metrics = useMemo(() => {
    ...
    const resolvedToday = complaints.filter(
      (c) =>
        c.status === "resolved" &&
        c.updated_at &&
        sameDay(new Date(c.updated_at), today),
    ).length;
    return {
      total,
      pending,
  ...
  return (
    <section className="w-full max-w-none mx-0 px-3 md:px-4 lg:px-6 py-6 min-h-[calc(100vh-80px)] md:h-[calc(100vh-80px)] md:overflow-hidden grid grid-cols-1 md:grid-cols-[220px,1fr] gap-6 text-gray-900 dark:text-gray-100">
      {/* Left Sidebar */}
      <aside className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm p-3 md:p-4 h-full md:self-stretch">
        ...
        <nav className="space-y-1 text-sm">
          <button
            ...
            className={`w-full text-left flex items-center gap-2 px-3 py-2 rounded-lg ${tab === "overview" ? "bg-blue-50 text-blue-700 dark:bg-blue-500/20 dark:text-blue-200" : "hover:bg-gray-50 text-gray-700 dark:hover:bg-gray-800 dark:text-gray-200"}`}
          >
          ...
          <a
            href="/complaints"
            className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-50 text-gray-700 dark:hover:bg-gray-800 dark:text-gray-200"
          >
          ...
          <button
            ...
            className={`w-full text-left flex items-center gap-2 px-3 py-2 rounded-lg ${tab === "users" ? "bg-blue-50 text-blue-700 dark:bg-blue-500/20 dark:text-blue-200" : "hover:bg-gray-50 text-gray-700 dark:hover:bg-gray-800 dark:text-gray-200"}`}
          >
          ...
          <button
            ...
            className={`w-full text-left flex items-center gap-2 px-3 py-2 rounded-lg ${tab === "reports" ? "bg-blue-50 text-blue-700 dark:bg-blue-500/20 dark:text-blue-200" : "hover:bg-gray-50 text-gray-700 dark:hover:bg-gray-800 dark:text-gray-200"}`}
          >
          ...
          <button
            ...
            className={`w-full text-left flex items-center gap-2 px-3 py-2 rounded-lg ${tab === "activities" ? "bg-blue-50 text-blue-700 dark:bg-blue-500/20 dark:text-blue-200" : "hover:bg-gray-50 text-gray-700 dark:hover:bg-gray-800 dark:text-gray-200"}`}
          >
        ...
        <div className="mb-6 flex items-center justify-between gap-4">
          ...
          {tab === "reports" && (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 dark:hover:bg-gray-800"
            >
          ...
          <>
            {tab === "overview" ? (
              <div className="md:flex-1 md:overflow-y-auto md:pr-2">
                ...
                <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm p-6 min-h-[260px] flex flex-col justify-between transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-blue-100 dark:hover:border-blue-500/40">
                  ...
                  <p className="text-base text-gray-600 dark:text-gray-300 leading-relaxed">
                    ...
                    we&apos;re improving city cleanliness every day.
                  </p>
                  <div className="mt-8">
                    <a
                      href="/complaints"
                      className="btn btn-ghost px-5 py-2 text-base text-black dark:text-black"
                    >
                      View All Complaints
                    </a>
                  </div>
...
function AdminStat({ icon, value, label }) {
  ...
  return (
    <div className="group rounded-2xl ring-1 ring-gray-100 dark:ring-gray-800 bg-white dark:bg-gray-900 shadow-sm p-8 min-h-[220px] flex flex-col items-center justify-center text-center bg-[radial-gradient(ellipse_at_top,rgba(59,130,246,0.06),transparent_60%)] transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:ring-blue-100 dark:hover:ring-blue-500/60">
      <div className="w-16 h-16 rounded-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-sm text-gray-600 dark:text-gray-200 flex items-center justify-center mb-3 transition-colors duration-200 group-hover:bg-blue-50 group-hover:border-blue-200 group-hover:text-blue-600 dark:group-hover:bg-blue-500/20 dark:group-hover:border-blue-400 dark:group-hover:text-blue-300">
        {icon}
      </div>
      <div className="text-4xl font-semibold leading-tight transition-transform duration-200 group-hover:scale-105 text-gray-900 dark:text-white">
        {formatted}
      </div>
      <div className="text-base text-gray-500 dark:text-gray-400 mt-1 group-hover:text-gray-700 dark:group-hover:text-gray-200">
        {label}
      </div>
    </div>
  );
...
// Sidebar icons
function SidebarOverviewIcon({ className = "w-4 h-4" }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function SidebarManageIcon({ className = "w-4 h-4" }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function SidebarUsersIcon({ className = "w-4 h-4" }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function SidebarReportIcon({ className = "w-4 h-4" }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function SidebarLogsIcon({ className = "w-4 h-4" }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function ReportsSection({ metrics, complaints = [], users = [] }) {
  ...
  const CATEGORY_ORDER = [
    ...
    },
    {
      ...
      label: "Water Logging",
      patterns: [
        /water\s*logging|waterlogging|water\s*loggging|standing\s*water|water\s*stagnant|flood|flooded|drainage\s*blocked/i,
      ],
    },
    {
      key: "illegal_parking",
      ...
      patterns: [
        /illegal\s*parking|no\s*parking|double\s*parking|encroach(ed|ment).*parking|vehicle\s*blocking|blocked\s*road.*car|bike\s*parked\s*illegally/i,
      ],
    },
  ];
  ...
  const topTypesPretty = CATEGORY_ORDER.map((cat, i) => ({
    label: cat.label,
    value: counts[i],
  }));
  ...
  const summaryBars = [
    {
      label: "Users",
      value: countUsers,
      color: "linear-gradient(180deg,#38bdf8,#0ea5e9)",
    },
    {
      label: "Volunteers",
      value: countVolunteers,
      color: "linear-gradient(180deg,#fb7185,#f43f5e)",
    },
    {
      label: "Total Complaints",
      value: metrics.total,
      color: "linear-gradient(180deg,#22d3ee,#0ea5e9)",
    },
    {
      label: "Pending",
      value: metrics.inReview + metrics.pending,
      color: "linear-gradient(180deg,#fb7185,#f97316)",
    },
    {
      label: "Resolved Today",
      value: metrics.resolvedToday,
  ...
  const totalStatus = Math.max(
    1,
    statusSlices.reduce((a, b) => a + (b.value || 0), 0),
  );
  let accS = 0;
  const statusGradient = `conic-gradient(from 90deg, ${statusSlices
    .map((s) => {
      const from = (accS / totalStatus) * 100;
      accS += s.value || 0;
      const to = (accS / totalStatus) * 100;
  ...
  const totalRoles = Math.max(
    1,
    roleSlices.reduce((a, b) => a + (b.value || 0), 0),
  );
  let accR = 0;
  const roleGradient = `conic-gradient(from 90deg, ${roleSlices
    .map((s) => {
      const from = (accR / totalRoles) * 100;
      accR += s.value || 0;
      const to = (accR / totalRoles) * 100;
      return `${s.color} ${from}% ${to}%`;
    })
    .join(", ")})`;
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col items-center gap-4">
          <div
            ...
            onMouseMove={(e) => {
              ...
              const innerR = hole
                ? hole.getBoundingClientRect().width / 2
                : rect.width * 0.35;
              ...
              const hit = statusRanges.find((rg, idx) => {
                ...
                return (
                  (ratio >= rg.from && ratio < rg.to) || (last && ratio === 1)
                );
              });
          ...
          >
            ...
            />
            <div className="donut-hole-status absolute inset-1/2 -translate-x-1/2 -translate-y-1/2 w-28 h-28 bg-white dark:bg-gray-900 rounded-full shadow-inner flex items-center justify-center text-center">
      ...
      <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm p-6">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          >
            ...
            />
            <div className="donut-hole-roles absolute inset-1/2 -translate-x-1/2 -translate-y-1/2 w-28 h-28 bg-white dark:bg-gray-900 rounded-full shadow-inner flex items-center justify-center text-center">
              <div className="text-sm text-gray-700 dark:text-gray-100">
                {hoverRole ? (
                  <>
      ...
      <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm p-6">
        ...
        <LineChart
          ...
          labels={last7Labels.map(formatDayShort)}
          height={160}
        />
      </div>
      ...
      <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm p-6">
        ...
        <LineChart
          ...
          labels={last30Labels.map((d, i) =>
            i % 5 === 0 ? formatDayShort(d) : "",
          )}
          height={160}
          dense
        />
          ...
          {summaryBars.map((b) => (
            ...
            >
              <div
                ...
                style={{
                  height: `${(b.value / maxSummary) * 100}%`,
                  minHeight: b.value > 0 ? 10 : 0,
                  background: b.color,
                }}
    ...
    <div className="w-full">
      ...
      >
        {labels.map((l, i) => (
          <div
            key={i}
            className={`text-[10px] text-gray-500 dark:text-gray-400 ${dense ? "" : "truncate"}`}
          >
            {l}
          </div>
        ))}
    ...
    <div className="w-full">
      <div className="flex items-end gap-4 h-64">
        {data.map((v, i) => (
          ...
          >
            <div
              className="w-full max-w-[80px] rounded-md bg-gradient-to-b from-blue-400 to-blue-600"
              style={{
                height: `${(v / max) * 100}%`,
                minHeight: v > 0 ? 10 : 0,
              }}
            ...
            />
            <div
              className="text-[11px] text-center text-gray-600 truncate w-full max-w-[80px]"
              title={labels[i]}
            >
              {labels[i]}
            </div>
      ...
      {items.map((it, idx) => {
        ...
        return (
          <div key={idx} className="flex items-center gap-4">
            <div
              className="w-40 text-sm text-gray-700 dark:text-gray-200 truncate"
              title={it.label}
            >
              {it.label}
            </div>
...
function UsersSection({ users = [], token, onUserUpdated }) {
  ...
  const changeRole = async (id, role) => {
    try {
      setSavingId(id);
      const updated = await api(`/users/${id}/role`, {
        method: "PUT",
        body: { role },
        token,
      });
  ...
  const RoleBadge = ({ role }) => {
    ...
    return (
      <span
        className={`px-2 py-0.5 rounded-full text-xs font-medium ${styles}`}
      >
        {role}
      </span>
    );
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
            {local
              ...
              .filter((u) =>
                locationFilter === "all"
                  ? true
                  : (u.location || "").trim().toLowerCase() === locationFilter,
              )
              .map((u) => (
                <tr
                  key={u._id}
...
function UsersFilters({
  ...
  return (
    <div className="px-6 py-3 border-b border-gray-100 dark:border-gray-800 flex flex-wrap items-center gap-3 text-sm">
      <div className="text-gray-600 dark:text-gray-300 flex items-center gap-2 mr-2">
        <span className="inline-block">Filters:</span>
      </div>
      {/* Location */}
      <select
        className="px-3 py-2 rounded-lg border border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100"
      ...
      <button
        type="button"
        onClick={onClear}
        className="text-indigo-600 hover:underline ml-auto dark:text-indigo-400"
      >
        Clear Filters
      </button>
      <div className="text-xs text-gray-500 dark:text-gray-400">
        Showing {showingCount} of {users.length}
      </div>
    </div>
  );
}
    ...
    <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm">
      <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={onRefresh}
          className="text-xs px-2 py-1 rounded border border-gray-200 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800 dark:text-gray-100"
        >
          Refresh
        </button>
      </div>
